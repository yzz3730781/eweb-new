...
const appMenu = {
  'menu.app.topology': "拓扑",
  'menu.app.topology.topology': "拓扑",
  'menu.app.device': "设备",
  'menu.app.device.device': "设备",

  'menu.app.alarm': "告警",
  'menu.app.alarm.monitor': "告警监控",
  'menu.app.alarm.history': "历史告警",
  'menu.app.alarm.config': "告警设置",

  'menu.app.performance': "性能",
  'menu.app.performance.monitor': "性能数据监控",
  'menu.app.performance.pmcollect': "性能数据补采",
  'menu.app.performance.search': "性能数据查询",
  'menu.app.performance.storeconf': "性能数据存储设置",
  'menu.app.performance.mrjob': "MR测量任务",
  'menu.app.performance.mrstoreconf': "MR第三方存储设置",
  'menu.app.performance.dimensiontrace': "维测监控",
  'menu.app.performance.trace': "信令追踪",

  'menu.app.site': "站点",
  'menu.app.site.site': "站点列表",
  'menu.app.site.site.list': "站点列表",
  'menu.app.site.site.home': "站点主页",
  'menu.app.site.site.config': "站点配置",
  'menu.app.site.site.cellHome': "小区主页",
  'menu.app.site.site.cellConfig': "小区配置",

  'menu.app.configure': "配置",
  'menu.app.configure.management': "配置管理",
  'menu.app.configure.import': "配置导入",
  'menu.app.configure.export': "配置导出",

  'menu.app.configure2': "配置",
  'menu.app.configure2.singleConfig': "小区/站点配置",
  'menu.app.configure2.paramgrpmgmt': "参数组管理",
  'menu.app.configure2.expert': "平台配置",

  'menu.app.son': "SON",
  'menu.app.son.management': "自配置管理",
  'menu.app.son.import': "自优化管理-设置",
  'menu.app.son.export': "自愈管理-自愈设置",

  'menu.app.reporter': "报表",
  'menu.app.reporter.templatemanagement': "模板管理",
  'menu.app.reporter.jobmanagement': "任务管理",
  'menu.app.reporter.history': "历史报表",

  'menu.app.maintain': "维护",
  'menu.app.maintain.assist': "命令助手",
  'menu.app.maintain.diagnose': "诊断测试",
  'menu.app.maintain.jobmanagement': "任务管理",
  'menu.app.maintain.configmanagement': "配置模板管理",

  'menu.app.software': "软件",
  'menu.app.software.bsnpatch': "基站软件&补丁包管理",
  'menu.app.software.omcsoftware': "网管系统软件管理",

  'menu.app.system': "系统",
  'menu.app.system.sysmonitor': "系统监视",
  'menu.app.system.dbmonitor': "数据库监视",
  'menu.app.system.logmanagement': "日志管理",
  'menu.app.system.backup': "系统备份",
  'menu.app.system.navmanagement': "导航树管理",

  'menu.app.security': "安全",
  'menu.app.security.usermanagement': "用户管理",
  'menu.app.security.rolemanagement': "角色管理",
  'menu.app.security.privilege': "权限管理",
  'menu.app.security.pwdstrategy': "密码策略",

  'menu.app.audit': "审计",
  'menu.app.audit.audit': "审计",
...
export default {
  ...
  'app.analysis.table.search-keyword': '搜索分析',
  ...
  'app.exception.description.403': '抱歉，您无权访问该页面',
  'app.exception.description.404': '抱歉，您访问的页面不存在',
  ...
  // "app.login.login": "登录",
  "app.login.remember": "记住我",
  "app.login.forget": "忘记密码",
  "app.login.register": "注册",
  "app.login.accountError": "用户名或者密码错误",
  "layouts.UserLayout.copyright": " 2020 版权归锐捷网络所有，如果未经许可擅自抄袭，本公司保留追究其法律责任的权利",
  "layouts.UserLayout.desc":" ",
  "menu.System": "系统配置",
  "menu.System.SystemConfig": "授权配置",
  "menu.System.SystemParam": "系统参数配置",
  "menu.System.AppParam": "APP/URL配置",
  "menu.System.AddictParam": "网络沉迷参数配置",
  "menu.System.DataSync":"数据同步",
  "menu.System.messageImport":"信息导入",
  "menu.System.roleManage":"角色管理",
  "menu.System.userManage":"账号管理",
  "menu.userCenter": "个人中心",
  "menu.account.modifyPwd": "修改密码",
  "menu.monitor": "监控信息",
  "menu.monitor.monitor": "设备状态",
  "modifyPassword.oldPassword":"原密码",
  "modifyPassword.oldPasswordNotNull":"原来的密码不能为空！",
  "modifyPassword.newPassword":"新密码",
  "modifyPassword.newPasswordNotNull":"新密码不能为空！",
  "modifyPassword.confirmPassword":"确认新密码",
  "modifyPassword.confirmPasswordNotNull":"确认新密码不能为空！",
  "modifyPassword.pleaseInputPassword":"请输入密码",
  "modifyPassword.twoPasswordNotMatch":"两次输入的密码不匹配!",
  "modifyPassword.shortestPasswordTip":"密码最短需要{length}位",
  "modifyPassword.updateSuccess":"密码更新成功",
  "modifyPassword.updateFail":"密码更新失败",
  "button.ok": "确认",
  "button.cancel": "取消",
  "button.submit": "提交",
  "button.reset": "重置",
